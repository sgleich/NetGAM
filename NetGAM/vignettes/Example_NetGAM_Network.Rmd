...
```{r,eval=FALSE}
library(mgcv)
# Load in species abundance dataframe. Here, the samples are rows (1-200) and the columns are species (V1-V400). The species abundance values here are relative abundance values.
